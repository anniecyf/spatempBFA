...
Diags.sequen <- diagnostics(regFixedL.simu.sequen, diags = c("dic", "dinf", "meanIC", "waic"), 
                            keepDeviance = TRUE)
save(Diags.sequen, 
...
regFixedL.simu.sequen <- bfaFixedL(Y ~ 0, data = dat, dist = D, time = Time,  K = K, 
                                   ...
                                   alphasWeightsToFiles = FALSE) 
save(regFixedL.simu.sequen, 
     file="regFixedL30simuSequenT500M64Iter30000specifyEqualTimeDistFnostorealphaweights.RData")
