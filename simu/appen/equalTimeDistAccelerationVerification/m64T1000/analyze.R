...
list.files()
load("regFixedL30simuT1000M64Iter30000.RData")
load("regFixedL30simuBlockT1000M64Iter30000.RData")
load("regFixedL30simuSequenT1000M64Iter30000nostorealphaweights.RData")
regFixedL.simu.sequen.fast <- regFixedL.simu.sequen
load("regFixedL30simuSequenT1000M64Iter30000specifyEqualTimeDistFnostorealphaweights.RData")
load("regVaryLjsimuSequenT1000M64Iter30000nostorealphaweight.RData")
regVaryLj.simu.sequen.fast <- regVaryLj.simu.sequen
load("regVaryLjsimuSequenT1000M64Iter30000specifyEqualTimeDistFnostorealphaweight.RData")
