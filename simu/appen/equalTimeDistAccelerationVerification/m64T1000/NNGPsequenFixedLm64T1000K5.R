...
Sys.time()
save(regFixedL.simu.sequen, file="regFixedL30simuSequenT1000M64Iter30000nostorealphaweights.RData")
...
save(Diags.sequen, file = "regFixedL30simuSequenT1000M64Iter30000DiagsNostorealphaweights.RData")
Deviance.sequen <- as.mcmc(Diags.sequen$deviance)
save(Deviance.sequen, file = "regFixedL30simuSequenT1000M64Iter30000DevianceNostorealphaweights.RData")
