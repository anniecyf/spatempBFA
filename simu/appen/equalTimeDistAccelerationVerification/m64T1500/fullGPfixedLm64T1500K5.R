...
save(regFixedL.simu, file="regFixedL30simuT1500M64Iter30000.RData")
library(coda)
Diags <- diagnostics(regFixedL.simu, diags = c("dic", "dinf", "meanIC", "waic"), keepDeviance = TRUE)
save(Diags, file = "regFixedL30simuT1500M64Iter30000Diags.RData")
Deviance <- as.mcmc(Diags$deviance)
save(Deviance, file = "regFixedL30simuT1500M64Iter30000Deviance.RData")
