...
regVaryLj.simu.sequen <- bfaVaryingLjs(Y ~ 0, data = dat, dist = D, time = Time,  K = K, LjVec = LjVec,
                                       ...
                                       storeWeights = FALSE) 
Sys.time()
save(regVaryLj.simu.sequen, file="regVaryLjsimuSequenT1500M64Iter30000specifyEqualTimeDistFnostorealphaweight.RData")
...
save(Diags.sequenVaryLj, file = "regVaryLjsimuSequenT1500M64Iter30000specifyEqualTimeDistFDiagsNostorealphaweight.RData")
Deviance.sequenVaryLj <- as.mcmc(Diags.sequenVaryLj$deviance)
save(Deviance.sequenVaryLj, file = "regVaryLjsimuSequenT1500M64Iter30000specifyEqualTimeDistFDevianceNostorealphaweight.RData")
