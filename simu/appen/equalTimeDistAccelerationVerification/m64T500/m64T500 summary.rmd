...
## all of the 8 matrices below are 5000 x 10 
# (10000 / 2 = 5000 kept post-burn-in MCMC iterations, 7 + 3 = 10 key parameters)
...
The results we have obtained corroborate these well. With `equalTimeDist = TRUE` specified, the overall model fitting time for our 4 models, i.e., `fullGPfixedL`, `NNGPblockFixedL`, `NNGPsequenFixedL`, and `NNGPsequenVaryLj`, are 7.04 hours, 7.03 hours, 7.04 hours, and 6.31 hours, respectively.^[It is worth noting that we utilized a version of our package with the extra step-wise time recording code portions to fit the above models. This package version is slower than our original package version presented in the GitHub repository.] If we do not take advantage of our tactics for evenly dispersed time points presented in Appendix B of our manuscript by specifying `equalTimeDist = FALSE` instead, we will need 28.98 days, 29.09 days, 29.03 days, and 28.74 days to fit the same 4 models using the same computation resources. 
