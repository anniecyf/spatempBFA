...
save(regFixedL.simu.block, file="regFixedL30simuBlockT500M64Iter30000specifyEqualTimeDistF.RData")
library(coda)
Diags.block <- diagnostics(regFixedL.simu.block, diags = c("dic", "dinf", "meanIC", "waic"), keepDeviance = TRUE)
save(Diags.block, file = "regFixedL30simuBlockT500M64Iter30000specifyEqualTimeDistFDiags.RData")
Deviance.block <- as.mcmc(Diags.block$deviance)
save(Deviance.block, file = "regFixedL30simuBlockT500M64Iter30000specifyEqualTimeDistFDeviance.RData")
