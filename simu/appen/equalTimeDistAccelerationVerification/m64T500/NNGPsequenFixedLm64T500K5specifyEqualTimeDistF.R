...
Sys.time()
save(regFixedL.simu.sequen, file="regFixedL30simuSequenT500M64Iter30000specifyEqualTimeDistFnostorealphaweights.RData")
...
save(Diags.sequen, file = "regFixedL30simuSequenT500M64Iter30000specifyEqualTimeDistFDiagsNostorealphaweights.RData")
Deviance.sequen <- as.mcmc(Diags.sequen$deviance)
save(Deviance.sequen, file = "regFixedL30simuSequenT500M64Iter30000specifyEqualTimeDistFDevianceNostorealphaweights.RData")
