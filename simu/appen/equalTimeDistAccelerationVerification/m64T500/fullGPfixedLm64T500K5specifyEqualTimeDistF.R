...
save(regFixedL.simu, file="regFixedL30simuT500M64Iter30000specifyEqualTimeDistF.RData")
library(coda)
Diags <- diagnostics(regFixedL.simu, diags = c("dic", "dinf", "meanIC", "waic"), keepDeviance = TRUE)
save(Diags, file = "regFixedL30simuT500M64Iter30000specifyEqualTimeDistFDiags.RData")
Deviance <- as.mcmc(Diags$deviance)
save(Deviance, file = "regFixedL30simuT500M64Iter30000specifyEqualTimeDistFDeviance.RData")
