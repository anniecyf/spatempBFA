...
#setwd(paste(projDirec, "simu/appen/real data ex/SSTm6006", sep = "/"))
...
set.seed(29)
testingLocs <- sample(1:nrow(SSTtrainingDF), size = 150, replace = FALSE)
APsi = 0.1; BPsi = 4.5
...
MCMC <- list(NBurn = 180000, NSims = 20000, NThin = 20, NPilot = 5)
library(spatempBFA)
library(coda)
Sys.time()
...
spatpredFixedLsequen <- predictNewLocFixedL(regFixedL.simu.sequen, 150, distOrigNew, distNewNew, 
