...
save(regFixedL.simu, file="regFixedL50simuT100M225K4Iter100000.RData")
...
save(Diags, file = "regFixedL50simuT100M225K4Iter100000Diags.RData")
Deviance <- as.mcmc(Diags$deviance)
save(Deviance, file = "regFixedL50simuT100M225K4Iter100000Deviance.RData")
