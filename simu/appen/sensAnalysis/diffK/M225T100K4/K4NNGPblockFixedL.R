...
save(regFixedL.simu.block, file="regFixedL50simuBlockT100M225K4Iter100000.RData")
...
save(Diags.block, file = "regFixedL50simuBlockT100M225K4Iter100000Diags.RData")
Deviance.block <- as.mcmc(Diags.block$deviance)
save(Deviance.block, file = "regFixedL50simuBlockT100M225K4Iter100000Deviance.RData")
