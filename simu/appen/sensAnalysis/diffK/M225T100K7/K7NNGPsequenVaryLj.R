...
regVaryLj.simu.sequen <- bfaVaryingLjs(Y ~ 0, data = dat, dist = D, time = Time,  K = K, LjVec = LjVec,
                                       ...
                                       storeWeights = FALSE) 
Sys.time()
save(regVaryLj.simu.sequen, file="regVaryLjSimuSequenT100M225K7Iter100000.RData")
...
save(Diags.sequenVaryLj, file = "regVaryLjSimuSequenT100M225K7Iter100000Diags.RData")
Deviance.sequenVaryLj <- as.mcmc(Diags.sequenVaryLj$deviance)
save(Deviance.sequenVaryLj, file = "regVaryLjSimuSequenT100M225K7Iter100000Deviance.RData")
