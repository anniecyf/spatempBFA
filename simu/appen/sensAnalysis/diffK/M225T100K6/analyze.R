...
setwd("M225T100K6")
#load("regFixedL50simuT100M225K6Iter100000.RData"); regFixedL.simu$runtime; # slower package version 14.02 hours rm(regFixedL.simu)
load("regFixedL50simuT100M225K6Iter100000Diags.RData")
load("regFixedL50simuT100M225K6Iter100000Deviance.RData") # Deviance
load("GibbsStepTimeFixedLfullGP.RData")
#load("regFixedL50simuBlockT100M225K6Iter100000.RData"); regFixedL.simu.block$runtime; # slower package version 13.54 hours rm(regFixedL.simu.block)
load("regFixedL50simuBlockT100M225K6Iter100000Diags.RData")
load("regFixedL50simuBlockT100M225K6Iter100000Deviance.RData") # Deviance.block
load("GibbsStepTimeFixedLblock.RData")
#load("regFixedL50simuSequenT100M225K6Iter100000.RData"); regFixedL.simu.sequen$runtime; # slower package version 14.84 hours rm(regFixedL.simu.sequen)
load("regFixedL50simuSequenT100M225K6Iter100000Diags.RData")
load("regFixedL50simuSequenT100M225K6Iter100000Deviance.RData") # Deviance.sequen
load("GibbsStepTimeFixedLsequen.RData")
#load("regVaryLjSimuSequenT100M225K6Iter100000.RData"); regVaryLj.simu.sequen$runtime; # slower package version 10.48 hours rm(regVaryLj.simu.sequen)
load("regVaryLjSimuSequenT100M225K6Iter100000Diags.RData")
load("regVaryLjSimuSequenT100M225K6Iter100000Deviance.RData") # Deviance.sequenVaryLj
...
ggarrange(fullGPfixedLpostDeviances, NNGPblockFixedLpostDeviances, 
          ...
          ncol = 2, nrow = 2)
ggsave("diffK6postDeviances.png", width = 16, height = 16, units = "cm")
