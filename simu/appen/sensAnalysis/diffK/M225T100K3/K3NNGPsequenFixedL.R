...
Sys.time()
save(regFixedL.simu.sequen, file="regFixedL50simuSequenT100M225K3Iter100000.RData")
...
save(Diags.sequen, file = "regFixedL50simuSequenT100M225K3Iter100000Diags.RData")
Deviance.sequen <- as.mcmc(Diags.sequen$deviance)
save(Deviance.sequen, file = "regFixedL50simuSequenT100M225K3Iter100000Deviance.RData")
