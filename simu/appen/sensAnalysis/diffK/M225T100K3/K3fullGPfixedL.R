...
MCMC <- list(NBurn = 80000, NSims = 10000, NThin = 2, NPilot = 5)
...
save(regFixedL.simu, file="regFixedL50simuT100M225K3Iter90000.RData")
...
save(Diags, file = "regFixedL50simuT100M225K3Iter90000Diags.RData")
Deviance <- as.mcmc(Diags$deviance)
save(Deviance, file = "regFixedL50simuT100M225K3Iter90000Deviance.RData")
