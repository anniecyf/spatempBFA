...
setwd("M225T100K5")
#load("regFixedL50simuT100M225K5Iter100000.RData"); regFixedL.simu$runtime; # slower package version 12.28 hours rm(regFixedL.simu)
...
#load("regFixedL50simuBlockT100M225K5Iter100000.RData"); regFixedL.simu.block$runtime; # slower package version 12.79 hours rm(regFixedL.simu.block)
...
#load("regFixedL50simuSequenT100M225K5Iter100000.RData"); regFixedL.simu.sequen$runtime; # slower package version 14.97 hours rm(regFixedL.simu.sequen)
...
#load("regVaryLjSimuSequenT100M225K5Iter100000.RData"); regVaryLj.simu.sequen$runtime; # slower package version 9.39 hours rm(regVaryLj.simu.sequen)
...
ggarrange(fullGPfixedLpostDeviances, NNGPblockFixedLpostDeviances, 
          ...
          ncol = 2, nrow = 2)
ggsave("diffK5postDeviances.png", width = 16, height = 16, units = "cm")
