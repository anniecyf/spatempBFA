...
setwd("setting2")
#load("regFixedL50simuT100M225K5Iter100000.RData"); regFixedL.simu$runtime; # slower package version 13.03 hours rm(regFixedL.simu)
...
#load("regFixedL50simuBlockT100M225K5Iter100000.RData"); regFixedL.simu.block$runtime; # slower package version 19.08 hours rm(regFixedL.simu.block)
...
#load("regFixedL50simuSequenT100M225K5Iter100000.RData"); regFixedL.simu.sequen$runtime; # slower package version 13.41 hours rm(regFixedL.simu.sequen)
...
#load("regVaryLjSimuSequenT100M225K5Iter100000.RData"); regVaryLj.simu.sequen$runtime; # slower package version 9.04 hours rm(regVaryLj.simu.sequen)
...
ggarrange(fullGPfixedLpostDeviances, NNGPblockFixedLpostDeviances, 
          ...
          ncol = 2, nrow = 2)
ggsave("diffHyPerParaSetting2postDeviances.png", width = 16, height = 16, units = "cm")
