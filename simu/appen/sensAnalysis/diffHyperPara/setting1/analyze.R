...
setwd("setting1")
#load("regFixedL50simuT100M225K5Iter100000.RData"); regFixedL.simu$runtime; # slower package version 12.3 hours rm(regFixedL.simu)
...
#load("regFixedL50simuBlockT100M225K5Iter100000.RData"); regFixedL.simu.block$runtime; # slower package version 19.78 hours rm(regFixedL.simu.block)
...
#load("regFixedL50simuSequenT100M225K5Iter100000.RData"); regFixedL.simu.sequen$runtime; # slower package version 15.13 hours rm(regFixedL.simu.sequen)
...
#load("regVaryLjSimuSequenT100M225K5Iter100000.RData"); regVaryLj.simu.sequen$runtime; # slower package version 9.36 hours rm(regVaryLj.simu.sequen)
