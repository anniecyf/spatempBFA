...
setwd("setting3")
#load("regFixedL50simuT100M225K5Iter100000.RData"); regFixedL.simu$runtime; # slower package version 14.23 hours rm(regFixedL.simu)
...
#load("regFixedL50simuBlockT100M225K5Iter100000.RData"); regFixedL.simu.block$runtime; # slower package version 18.42 hours rm(regFixedL.simu.block)
...
#load("regFixedL50simuSequenT100M225K5Iter100000.RData"); regFixedL.simu.sequen$runtime; # slower package version 15.19 hours rm(regFixedL.simu.sequen)
...
#load("regVaryLjSimuSequenT100M225K5Iter100000.RData"); regVaryLj.simu.sequen$runtime; # slower package version 9.23 hours rm(regVaryLj.simu.sequen)
...
ggarrange(fullGPfixedLpostDeviances, NNGPblockFixedLpostDeviances, 
          ...
          ncol = 2, nrow = 2)
ggsave("diffHyPerParaSetting3postDeviances.png", width = 16, height = 16, units = "cm")
