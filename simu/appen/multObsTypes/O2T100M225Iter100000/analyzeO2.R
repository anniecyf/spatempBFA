...
setwd(paste0(projDirec, "/simu/appen/multObsTypes/O2T100M225Iter100000"))
...
# load("regFixedL50simuO2T100M225Iter100000.RData"); regFixedL.simu$runtime # slower package version 1.54 days; rm(regFixedL.simu)
...
# load("regFixedL50simuBlockO2T100M225Iter100000.RData"); regFixedL.simu.block$runtime # slower package version 1.45 days; rm(regFixedL.simu.block)
...
# load("regFixedL50simuSequenO2T100M225Iter100000.RData"); regFixedL.simu.sequen$runtime # slower package version 1.86 days; rm(regFixedL.simu.sequen)
...
# load("regVaryLjSimuSequenO2T100M225Iter100000.RData"); regVaryLj.simu.sequen$runtime # slower package version; rm(regVaryLj.simu.sequen)
NKeep <- 10000
