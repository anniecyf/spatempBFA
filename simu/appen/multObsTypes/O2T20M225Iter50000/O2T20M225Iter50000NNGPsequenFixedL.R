...
Sys.time()
save(regFixedL.simu.sequen, file="regFixedL30simuSequenO2T20M225Iter50000.RData")
...
save(Diags.sequen, file = "regFixedL30simuSequenO2T20M225Iter50000Diags.RData")
Deviance.sequen <- as.mcmc(Diags.sequen$deviance)
save(Deviance.sequen, file = "regFixedL30simuSequenO2T20M225Iter50000Deviance.RData")
