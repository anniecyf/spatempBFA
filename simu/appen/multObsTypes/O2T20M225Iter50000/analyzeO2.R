...
setwd(paste0(projDirec, "/simu/appen/multObsTypes/O2T20M225Iter50000"))
...
# load("regFixedL30simuO2T20M225Iter50000.RData"); regFixedL.simu$runtime # slower package version  hours; rm(regFixedL.simu)
...
# load("regFixedL30simuBlockO2T20M225Iter50000.RData"); regFixedL.simu.block$runtime # slower package version  hours; rm(regFixedL.simu.block)
...
# load("regFixedL30simuSequenO2T20M225Iter50000.RData"); regFixedL.simu.sequen$runtime # slower package version  hours; rm(regFixedL.simu.sequen)
