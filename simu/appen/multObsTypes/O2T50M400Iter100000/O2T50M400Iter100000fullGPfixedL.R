...
save(regFixedL.simu, file="regFixedL50simuO2T50M400Iter100000.RData")
...
save(Diags, file = "regFixedL50simuO2T50M400Iter100000Diags.RData")
Deviance <- as.mcmc(Diags$deviance)
save(Deviance, file = "regFixedL50simuO2T50M400Iter100000Deviance.RData")
