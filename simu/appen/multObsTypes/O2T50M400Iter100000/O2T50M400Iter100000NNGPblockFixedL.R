...
save(regFixedL.simu.block, file="regFixedL50simuBlockO2T50M400Iter100000.RData")
...
save(Diags.block, file = "regFixedL50simuBlockO2T50M400Iter100000Diags.RData")
Deviance.block <- as.mcmc(Diags.block$deviance)
save(Deviance.block, file = "regFixedL50simuBlockO2T50M400Iter100000Deviance.RData")
