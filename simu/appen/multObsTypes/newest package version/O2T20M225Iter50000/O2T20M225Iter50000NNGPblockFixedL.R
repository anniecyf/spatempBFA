...
save(regFixedL.simu.block, file="regFixedL30simuBlockO2T20M225Iter50000.RData")
...
save(Diags.block, file = "regFixedL30simuBlockO2T20M225Iter50000Diags.RData")
Deviance.block <- as.mcmc(Diags.block$deviance)
save(Deviance.block, file = "regFixedL30simuBlockO2T20M225Iter50000Deviance.RData")
