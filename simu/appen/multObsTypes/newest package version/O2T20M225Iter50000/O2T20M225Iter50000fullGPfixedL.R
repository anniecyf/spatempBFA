...
save(regFixedL.simu, file="regFixedL30simuO2T20M225Iter50000.RData")
...
save(Diags, file = "regFixedL30simuO2T20M225Iter50000Diags.RData")
Deviance <- as.mcmc(Diags$deviance)
save(Deviance, file = "regFixedL30simuO2T20M225Iter50000Deviance.RData")
