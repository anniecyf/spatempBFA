...
Sys.time()
save(regFixedL.simu.sequen, file="regFixedL50simuSequenO2T200M400Iter100000.RData")
...
save(Diags.sequen, file = "regFixedL50simuSequenO2T200M400Iter100000Diags.RData")
Deviance.sequen <- as.mcmc(Diags.sequen$deviance)
save(Deviance.sequen, file = "regFixedL50simuSequenO2T200M400Iter100000Deviance.RData")
