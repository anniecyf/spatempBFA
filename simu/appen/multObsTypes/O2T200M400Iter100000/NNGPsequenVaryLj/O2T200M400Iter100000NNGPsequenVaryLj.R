...
regVaryLj.simu.sequen <- bfaVaryingLjs(Y ~ 0, data = dat, dist = D, time = Time,  K = K, LjVec = LjVec,
                                       ...
                                       storeWeights = TRUE) 
Sys.time()
save(regVaryLj.simu.sequen, file="regVaryLjSimuSequenO2T200M400Iter100000.RData")
...
save(Diags.sequenVaryLj, file = "regVaryLjSimuSequenO2T200M400Iter100000Diags.RData")
Deviance.sequenVaryLj <- as.mcmc(Diags.sequenVaryLj$deviance)
save(Deviance.sequenVaryLj, file = "regVaryLjSimuSequenO2T200M400Iter100000Deviance.RData")
