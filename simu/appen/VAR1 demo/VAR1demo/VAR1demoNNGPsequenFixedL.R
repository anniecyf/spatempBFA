...
save(VAR1bfaFixedL.simu.sequen, file="regFixedL50simuSequenT200M225Iter20000.RData")
save(Diags.VAR1fixedL.sequen, file = "regFixedL50simuSequenT200M225Iter20000Diags.RData")
save(Deviance.VAR1fixedL.sequen, file = "regFixedL50simuSequenT200M225Iter20000Deviance.RData")