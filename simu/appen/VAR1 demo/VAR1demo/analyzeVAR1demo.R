...
ggarrange(fullGPfixedLpostDeviances, NNGPblockFixedLpostDeviances, 
          ...
          ncol = 2, nrow = 2)
ggsave("VAR1T200M225postDeviances.png", width = 16, height = 16, units = "cm")
# diagnostics all comparable; NNGPblockFixedL and NNGPsequenFixedL clearly better than fullGPfixedL in pd, dic, and p_waic_1
# posterior deviances fullGPfixedL slightly better than NNGPblockFixedL and NNGPsequenFixedL significantly better than NNGPsequenVaryLj