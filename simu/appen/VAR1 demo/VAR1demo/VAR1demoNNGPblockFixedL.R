...
save(VAR1bfaFixedL.simu.block, file="regFixedL50simuBlockT200M225Iter20000.RData")
save(Diags.VAR1fixedL.block, file = "regFixedL50simuBlockT200M225Iter20000Diags.RData")
save(Deviance.VAR1fixedL.block, file = "regFixedL50simuBlockT200M225Iter20000Deviance.RData")