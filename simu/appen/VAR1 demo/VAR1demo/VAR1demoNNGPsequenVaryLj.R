...
#MCMC <- list(NBurn = 10000, NSims = 10000, NThin = 1, NPilot = 20) # default
Sys.time()
...
save(VAR1regVaryLj.simu.sequen, file="regVaryLjSimuSequenT200M225Iter20000.RData")
save(Diags.VAR1sequenVaryLj.sequen, file = "regVaryLjSimuSequenT200M225Iter20000Diags.RData")
save(Deviance.VAR1sequenVaryLj.sequen, file = "regVaryLjSimuSequenT200M225Iter20000Deviance.RData")