...
save(regFixedL.simu, file="regFixedL50simuT50M400Iter30000.RData")
library(coda)
Diags <- diagnostics(regFixedL.simu, diags = c("dic", "dinf", "meanIC", "waic"), keepDeviance = TRUE)
save(Diags, file = "regFixedL50simuT50M400Iter30000Diags.RData")
Deviance <- as.mcmc(Diags$deviance)
save(Deviance, file = "regFixedL50simuT50M400Iter30000Deviance.RData")
