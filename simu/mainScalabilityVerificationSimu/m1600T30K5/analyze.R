rm(list=ls())
setwd("C:/Users/annie/OneDrive - National University of Singapore/Documents/PhD/research/server/spatempBFA/simu/mainScalabilityVerificationSimu/m1600T30K5")
list.files()
