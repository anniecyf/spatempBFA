...
Sys.time()
save(regFixedL.simu.sequen, file="regFixedL50simuSequenT50M1600Iter30000nostorealphaweights.RData")
...
save(Diags.sequen, file = "regFixedL50simuSequenT50M1600Iter30000DiagsNostorealphaweights.RData")
Deviance.sequen <- as.mcmc(Diags.sequen$deviance)
save(Deviance.sequen, file = "regFixedL50simuSequenT50M1600Iter30000DevianceNostorealphaweights.RData")
