...
```{r echo = F}
rm(list=ls())
wd <- "C:/Users/annie/OneDrive - National University of Singapore/Documents/PhD/research/first paper/spatempBFA/simu/mainScalabilityVerificationSimu/m900T30K5"
```
```{r}
setwd(wd)
