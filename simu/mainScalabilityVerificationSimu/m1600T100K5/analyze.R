rm(list=ls())
setwd("C:/Users/annie/OneDrive - National University of Singapore/Documents/PhD/research/first paper/spatempBFA/simu/mainScalabilityVerificationSimu/m1600T100K5")
list.files()
load("regFixedL50simuT100M1600Iter30000.RData")
load("regFixedL50simuBlockT100M1600Iter30000.RData")
load("regFixedL50simuSequenT100M1600Iter30000nostorealphaweights.RData")
load("regVaryLjsimuSequenT100M1600Iter30000nostorealphaweight.RData")
