...
save(regFixedL.simu.block, file="regFixedL50simuBlockT100M1600Iter30000.RData")
library(coda)
Diags.block <- diagnostics(regFixedL.simu.block, diags = c("dic", "dinf", "meanIC", "waic"), keepDeviance = TRUE)
save(Diags.block, file = "regFixedL50simuBlockT100M1600Iter30000Diags.RData")
Deviance.block <- as.mcmc(Diags.block$deviance)
save(Deviance.block, file = "regFixedL50simuBlockT100M1600Iter30000Deviance.RData")
