...
setwd("../fullGPfixedL")
# load("toyExfullGPfixedL.RData"); regFixedL.simu$runtime # longer package version 15.77 hours
# rm(regFixedL.simu)
...
# load("toyExNNGPblockFixedL.RData"); regFixedL.simu.block$runtime # longer package version 15.46 hours
...
# load("toyExNNGPsequenFixedL.RData"); regFixedL.simu.sequen$runtime # longer package version 15.19 hours
...
# load("toyExNNGPsequenVaryLj.RData"); regVaryLj.simu.sequen$runtime # longer package version 14.58 hours
