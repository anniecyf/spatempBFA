rm(list=ls())
setwd("C:/Users/annie/OneDrive - National University of Singapore/Documents/PhD/research/first paper/spatempBFA/simu/mainScalabilityVerificationSimu/m3600T50K5")
list.files()
load("regFixedL50simuT50M3600Iter30000.RData")
load("regFixedL50simuBlockT50M3600Iter30000.RData")
load("regFixedL50simuSequenT50M3600Iter30000nostorealphaweights.RData")
load("regVaryLjsimuSequenT50M3600Iter30000nostorealphaweight.RData")
