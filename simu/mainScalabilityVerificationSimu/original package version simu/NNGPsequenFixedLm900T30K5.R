...
Sys.time()
save(regFixedL.simu.sequen, file="regFixedL50simuSequenT30M900Iter30000nostorealphaweights.RData")
...
save(Diags.sequen, file = "regFixedL50simuSequenT30M900Iter30000DiagsNostorealphaweights.RData")
Deviance.sequen <- as.mcmc(Diags.sequen$deviance)
save(Deviance.sequen, file = "regFixedL50simuSequenT30M900Iter30000DevianceNostorealphaweights.RData")
