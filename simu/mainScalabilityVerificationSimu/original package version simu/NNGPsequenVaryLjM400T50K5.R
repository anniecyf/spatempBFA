...
regVaryLj.simu.sequen <- bfaVaryingLjs(Y ~ 0, data = dat, dist = D, time = Time,  K = K, LjVec = LjVec,
                                       ...
                                       storeWeights = FALSE) 
Sys.time()
save(regVaryLj.simu.sequen, file="regVaryLjsimuSequenT50M400Iter30000nostorealphaweight.RData")
...
save(Diags.sequenVaryLj, file = "regVaryLjsimuSequenT50M400Iter30000DiagsNostorealphaweight.RData")
Deviance.sequenVaryLj <- as.mcmc(Diags.sequenVaryLj$deviance)
save(Deviance.sequenVaryLj, file = "regVaryLjsimuSequenT50M400Iter30000DevianceNostorealphaweight.RData")
