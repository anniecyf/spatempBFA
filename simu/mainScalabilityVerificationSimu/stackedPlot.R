...
library(tidyverse)
library(ggpubr)
modelVec <- rep(c("fullGPfixedL", "NNGPblockFixedL", "NNGPsequenFixedL", "NNGPsequenVaryLj"), each = 4)
paraVec <- rep(c("z or u", "xi", "alpha", "kappa and rho"), 4)
...
m3600T100plot <- ggplot(m3600T100DF, aes(x = modelVec, y = meanTimeVec, fill = paraVec, group = paraVec)) +
  labs(x = "Model", y = "Mean Gibbs Sampler Time (sec)") +
  ...
  geom_area(data = m3600T100DF %>% filter(modelVec %in% c("fullGPfixedL", "NNGPblockFixedL")),
            aes(x = c("fullGPfixedL" = 1.25, "NNGPblockFixedL" = 1.75)[modelVec]), 
            position = "stack", color = "black", fill = NA, outline.type = "both") +
  geom_area(data = m3600T100DF %>% filter(modelVec %in% c("NNGPblockFixedL", "NNGPsequenFixedL")),
            aes(x = c("NNGPblockFixedL" = 2.25, "NNGPsequenFixedL" = 2.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both") +
  geom_area(data = m3600T100DF %>% filter(modelVec %in% c("NNGPsequenFixedL", "NNGPsequenVaryLj")),
            aes(x = c("NNGPsequenFixedL" = 3.25, "NNGPsequenVaryLj" = 3.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both")
m3600T100plot
setwd("../m3600T50K5")
load("GibbsStepTimeFixedLfullGP.RData") # GibbsStepTimeFixedLfullGP
...
m3600T50plot <- ggplot(m3600T50DF, aes(x = modelVec, y = meanTimeVec, fill = paraVec, group = paraVec)) +
  ...
  scale_fill_manual(values = legendColors, 
                    guide = guide_legend(title = "Parameter", label.position = "top", nrow = 1)) +
  geom_area(data = m3600T50DF %>% filter(modelVec %in% c("fullGPfixedL", "NNGPblockFixedL")),
            aes(x = c("fullGPfixedL" = 1.25, "NNGPblockFixedL" = 1.75)[modelVec]), 
            position = "stack", color = "black", fill = NA, outline.type = "both") +
  geom_area(data = m3600T50DF %>% filter(modelVec %in% c("NNGPblockFixedL", "NNGPsequenFixedL")),
            aes(x = c("NNGPblockFixedL" = 2.25, "NNGPsequenFixedL" = 2.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both") +
  geom_area(data = m3600T50DF %>% filter(modelVec %in% c("NNGPsequenFixedL", "NNGPsequenVaryLj")),
            aes(x = c("NNGPsequenFixedL" = 3.25, "NNGPsequenVaryLj" = 3.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both")
m3600T50plot
setwd("../m1600T100K5")
...
m1600T100plot <- ggplot(m1600T100DF, aes(x = modelVec, y = meanTimeVec, fill = paraVec, group = paraVec)) +
  ...
  scale_fill_manual(values = legendColors, 
                    guide = guide_legend(title = "Parameter", label.position = "top", nrow = 1)) +
  geom_area(data = m1600T100DF %>% filter(modelVec %in% c("fullGPfixedL", "NNGPblockFixedL")),
            aes(x = c("fullGPfixedL" = 1.25, "NNGPblockFixedL" = 1.75)[modelVec]), 
            position = "stack", color = "black", fill = NA, outline.type = "both") +
  geom_area(data = m1600T100DF %>% filter(modelVec %in% c("NNGPblockFixedL", "NNGPsequenFixedL")),
            aes(x = c("NNGPblockFixedL" = 2.25, "NNGPsequenFixedL" = 2.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both") +
  geom_area(data = m1600T100DF %>% filter(modelVec %in% c("NNGPsequenFixedL", "NNGPsequenVaryLj")),
            aes(x = c("NNGPsequenFixedL" = 3.25, "NNGPsequenVaryLj" = 3.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both")
m1600T100plot
setwd("../m1600T50K5")
...
m1600T50plot <- ggplot(m1600T50DF, aes(x = modelVec, y = meanTimeVec, fill = paraVec, group = paraVec)) +
  ...
  scale_fill_manual(values = legendColors, 
                    guide = guide_legend(title = "Parameter", label.position = "top", nrow = 1)) +
  geom_area(data = m1600T50DF %>% filter(modelVec %in% c("fullGPfixedL", "NNGPblockFixedL")),
            aes(x = c("fullGPfixedL" = 1.25, "NNGPblockFixedL" = 1.75)[modelVec]), 
            position = "stack", color = "black", fill = NA, outline.type = "both") +
  geom_area(data = m1600T50DF %>% filter(modelVec %in% c("NNGPblockFixedL", "NNGPsequenFixedL")),
            aes(x = c("NNGPblockFixedL" = 2.25, "NNGPsequenFixedL" = 2.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both") +
  geom_area(data = m1600T50DF %>% filter(modelVec %in% c("NNGPsequenFixedL", "NNGPsequenVaryLj")),
            aes(x = c("NNGPsequenFixedL" = 3.25, "NNGPsequenVaryLj" = 3.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both")
m1600T50plot
setwd("../m1600T30K5")
...
m1600T30plot <- ggplot(m1600T30DF, aes(x = modelVec, y = meanTimeVec, fill = paraVec, group = paraVec)) +
  ...
  scale_fill_manual(values = legendColors, 
                    guide = guide_legend(title = "Parameter", label.position = "top", nrow = 1)) +
  geom_area(data = m1600T30DF %>% filter(modelVec %in% c("fullGPfixedL", "NNGPblockFixedL")),
            aes(x = c("fullGPfixedL" = 1.25, "NNGPblockFixedL" = 1.75)[modelVec]), 
            position = "stack", color = "black", fill = NA, outline.type = "both") +
  geom_area(data = m1600T30DF %>% filter(modelVec %in% c("NNGPblockFixedL", "NNGPsequenFixedL")),
            aes(x = c("NNGPblockFixedL" = 2.25, "NNGPsequenFixedL" = 2.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both") +
  geom_area(data = m1600T30DF %>% filter(modelVec %in% c("NNGPsequenFixedL", "NNGPsequenVaryLj")),
            aes(x = c("NNGPsequenFixedL" = 3.25, "NNGPsequenVaryLj" = 3.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both")
m1600T30plot
setwd("../m900T50K5")
...
m900T50plot <- ggplot(m900T50DF, aes(x = modelVec, y = meanTimeVec, fill = paraVec, group = paraVec)) +
  ...
  scale_fill_manual(values = legendColors, 
                    guide = guide_legend(title = "Parameter", label.position = "top", nrow = 1)) +
  geom_area(data = m900T50DF %>% filter(modelVec %in% c("fullGPfixedL", "NNGPblockFixedL")),
            aes(x = c("fullGPfixedL" = 1.25, "NNGPblockFixedL" = 1.75)[modelVec]), 
            position = "stack", color = "black", fill = NA, outline.type = "both") +
  geom_area(data = m900T50DF %>% filter(modelVec %in% c("NNGPblockFixedL", "NNGPsequenFixedL")),
            aes(x = c("NNGPblockFixedL" = 2.25, "NNGPsequenFixedL" = 2.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both") +
  geom_area(data = m900T50DF %>% filter(modelVec %in% c("NNGPsequenFixedL", "NNGPsequenVaryLj")),
            aes(x = c("NNGPsequenFixedL" = 3.25, "NNGPsequenVaryLj" = 3.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both")
m900T50plot
setwd("../m900T30K5")
...
m900T30plot <- ggplot(m900T30DF, aes(x = modelVec, y = meanTimeVec, fill = paraVec, group = paraVec)) +
  ...
  scale_fill_manual(values = legendColors, 
                    guide = guide_legend(title = "Parameter", label.position = "top", nrow = 1)) +
  geom_area(data = m900T30DF %>% filter(modelVec %in% c("fullGPfixedL", "NNGPblockFixedL")),
            aes(x = c("fullGPfixedL" = 1.25, "NNGPblockFixedL" = 1.75)[modelVec]), 
            position = "stack", color = "black", fill = NA, outline.type = "both") +
  geom_area(data = m900T30DF %>% filter(modelVec %in% c("NNGPblockFixedL", "NNGPsequenFixedL")),
            aes(x = c("NNGPblockFixedL" = 2.25, "NNGPsequenFixedL" = 2.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both") +
  geom_area(data = m900T30DF %>% filter(modelVec %in% c("NNGPsequenFixedL", "NNGPsequenVaryLj")),
            aes(x = c("NNGPsequenFixedL" = 3.25, "NNGPsequenVaryLj" = 3.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both")
m900T30plot
setwd("../m400T50K5")
...
m400T50plot <- ggplot(m400T50DF, aes(x = modelVec, y = meanTimeVec, fill = paraVec, group = paraVec)) +
  ...
  scale_fill_manual(values = legendColors, 
                    guide = guide_legend(title = "Parameter", label.position = "top", nrow = 1)) +
  geom_area(data = m400T50DF %>% filter(modelVec %in% c("fullGPfixedL", "NNGPblockFixedL")),
            aes(x = c("fullGPfixedL" = 1.25, "NNGPblockFixedL" = 1.75)[modelVec]), 
            position = "stack", color = "black", fill = NA, outline.type = "both") +
  geom_area(data = m400T50DF %>% filter(modelVec %in% c("NNGPblockFixedL", "NNGPsequenFixedL")),
            aes(x = c("NNGPblockFixedL" = 2.25, "NNGPsequenFixedL" = 2.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both") +
  geom_area(data = m400T50DF %>% filter(modelVec %in% c("NNGPsequenFixedL", "NNGPsequenVaryLj")),
            aes(x = c("NNGPsequenFixedL" = 3.25, "NNGPsequenVaryLj" = 3.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both")
m400T50plot
setwd("../m400T30K5")
...
m400T30plot <- ggplot(m400T30DF, aes(x = modelVec, y = meanTimeVec, fill = paraVec, group = paraVec)) +
  ...
  scale_fill_manual(values = legendColors, 
                    guide = guide_legend(title = "Parameter", label.position = "top", nrow = 1)) +
  geom_area(data = m400T30DF %>% filter(modelVec %in% c("fullGPfixedL", "NNGPblockFixedL")),
            aes(x = c("fullGPfixedL" = 1.25, "NNGPblockFixedL" = 1.75)[modelVec]), 
            position = "stack", color = "black", fill = NA, outline.type = "both") +
  geom_area(data = m400T30DF %>% filter(modelVec %in% c("NNGPblockFixedL", "NNGPsequenFixedL")),
            aes(x = c("NNGPblockFixedL" = 2.25, "NNGPsequenFixedL" = 2.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both") +
  geom_area(data = m400T30DF %>% filter(modelVec %in% c("NNGPsequenFixedL", "NNGPsequenVaryLj")),
            aes(x = c("NNGPsequenFixedL" = 3.25, "NNGPsequenVaryLj" = 3.75)[modelVec]), 
            position = "stack", color = "black",fill = NA, outline.type = "both")
m400T30plot
setwd("..")
...
ggsave("9stackedPlots.png", width = 42, height = 42, units = "cm")
