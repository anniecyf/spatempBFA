//
//  functions used in spatempBFA package
//

#ifndef __spatempBFA__
#define __spatempBFA__
...
double rigammaRcpp(double shape, double rate);
double rgammaRcpp(double shape, double rate);
