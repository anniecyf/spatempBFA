...
// [[Rcpp::export]]
Rcpp::List VAR1bfaRcppFixedL(Rcpp::List DatObj_List,  Rcpp::List HyPara_List,
    ...
    VAR1datobjFixedL DatObj = VAR1ConvertDatObjFixedL(DatObj_List);
    VAR1hypara HyPara = VAR1ConvertHyPara(HyPara_List);
    VAR1metrobj MetrObj = VAR1ConvertMetrObj(MetrObj_List);
    VAR1paraFixedL Para = VAR1ConvertParaFixedL(Para_List);
    int BNP = DatObj.CL;
    paraCLfixedL ParaCL {};
    ...
    std::pair<VAR1paraFixedL, paraCLfixedL> XiThetaUpdate {};
    std::pair<VAR1datobjFixedL, VAR1paraFixedL> DAUpdate {};
    std::pair<spatpara1, VAR1metrobj> Update1 {};
    std::pair<spatpara2, VAR1metrobj> Update2 {};
